    ...
    <form @submit.prevent="submit">
        <div className="flex card w-96 shadow-xl">
            <div className="card-body">
                ...
                <label for="first_name" class="form-label uppercase font-thin">First Name:</label>
                ...
                <label for="last_name" class="form-label uppercase font-thin">Last Name:</label>
                ...
                <label for="email_address" class="form-label uppercase font-thin">Email Address:</label>
                ...
                <label for="password" class="form-label uppercase font-thin">Password:</label>
