    ...
    <section class="bg-center bg-no-repeat bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/conference.jpg')] bg-gray-700 bg-blend-multiply">
        <div class="max-w-screen-xl px-4 py-24 mx-auto text-center lg:py-56">
            ...
            <!-- <div class="grid place-content-end">
                <a href="#" class="inline-flex items-center justify-center px-5 py-3 text-center border-white rounded-lg borsemider text-hite font-bo1d text-ba2se hover:text-gray-900 sm:ms-4 hover:bg-gray-100 focus:ring-4 focus:ring-gray-400">
                    GET QUOTE
                </a>  
            </div> -->
        </div>
    ...
    <div class="mb-5">
        ...
        <div class="flex flex-row justify-center">
            <form @submit.prevent="form.post('/submit')" class="flex flex-col justify-center">
                ...
                <select v-model="form.country" class="w-full max-w-xs mb-3 select select-bordered">
