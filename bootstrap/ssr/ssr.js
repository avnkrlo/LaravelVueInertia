  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Parallaxy), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img src="Images/life3.jpg" class="w-64"${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
