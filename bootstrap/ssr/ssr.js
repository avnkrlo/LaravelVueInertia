import { ref, unref, withCtx, createVNode, createTextVNode, useSSRContext, resolveComponent, onMounted, onUnmounted, mergeProps, createSSRApp, h as h$1 } from "vue";
import { ssrRenderComponent, ssrRenderClass, ssrRenderStyle, ssrRenderSlot, ssrRenderAttr, ssrInterpolate, ssrIncludeBooleanAttr, ssrLooseContain, ssrLooseEqual, ssrRenderAttrs } from "vue/server-renderer";
...
const _sfc_main$f = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="${ssrRenderClass(["w-full md:block md:w-auto", { "hidden": !_ctx.isNavbarOpen }])}" id="navbar-dropdown"><ul class="flex flex-col p-4 mt-4 font-medium border border-gray-100 rounded-lg md:p-0 bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700"><li>`);
      _push(ssrRenderComponent(unref(Link), {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_Link, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img src="Images/cck_logo.png" class="h-25 me-3" alt="FlowBite Logo"${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
...
const _sfc_main$a = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[--><section class="bg-center bg-no-repeat bg-[url(&#39;https://flowbite.s3.amazonaws.com/docs/jumbotron/conference.jpg&#39;)] bg-gray-700 bg-blend-multiply"><div class="max-w-screen-xl mx-auto lg:py-56"><h1 class="mb-4 text-4xl font-extrabold leading-none tracking-tight text-white uppercase md:text-5xl lg:text-6xl"> Come Join Our Team! </h1><p class="text-4xl text-white"> Great opportunity awaits you! </p></div></section><button type="button" class="!fixed bottom-5 end-5 hidden rounded-full bg-orange-600 p-3 text-xs font-medium uppercase leading-tight text-white border border-orange-300 shadow-md transition duration-150 ease-in-out hover:bg-transparent hover:shadow-lg hover:text-orange-300 focus:bg-orange-600 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-orange-600 active:shadow-lg" id="btn-back-to-top"><span class="[&amp;&gt;svg]:w-4"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="3" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 10.5 12 3m0 0 7.5 7.5M12 3v18"></path></svg></span></button><div class="pt-5 pb-5"><hr class="my-6 border-yellow-300 sm:mx-auto dark:border-yellow-300 lg:my-8"><h1 class="flex max-w-screen-xl mx-auto mb-5 text-4xl font-bold text-yellow-300">Why CCK City Network, Inc.</h1><p class="flex max-w-screen-xl mx-auto text-xl text-justify"> There are growing opportunities here at CCK. It offers an exciting way to exercise one&#39;s skills and challenge weaknesses to be turned into assets. This company demonstrates innovation and invites development not only individually but as a team and family. Its top notch reputation built in the industry would make anyone part of it proud and create a culture that pursues excellence. </p><hr class="my-6 border-yellow-300 sm:mx-auto dark:border-yellow-300 lg:my-8"><h1 class="grid mx-auto text-3xl font-bold text-yellow-300 uppercase place-content-center">Life at CCK</h1><hr class="my-6 border-yellow-300 sm:mx-auto dark:border-yellow-300 lg:my-8"><p class="flex max-w-screen-xl mx-auto mb-5 text-xl text-justify"> Here at CCK we remind ourselves that we are greater than our problems and refuse to give up on difficult tasks despite the tenacity and use these struggles to grow better. We are determined to achieve our goals and ensure success in things being done. We foster an environment where relationships matter within our teammates to build our efficiency, innovate faster, and to learn from each other. We believe that being disciplined is critical to our success, not only for one’s self but also for everyone in the team. We carefully choose our decisions and consult one another to strengthen the culture of pursuing excellence here at CCK </p></div><div class="mb-10 bg-blue-600 shadow-2xl"><div class="flex max-w-screen-sm pt-5 pb-5 mx-auto"><figure class="relative max-w-sm cursor-pointer filter blur-sm hover:blur-none"><img class="h-64 w-128" src="Images/life1.jpg" alt="image description"><figcaption class="absolute px-4 text-lg text-white bottom-5"><p>Here at CCK we remind each other that we are greater than our problems and refuse to give up on difficult tasks despite the tenacity and use these struggles to grow better.</p></figcaption></figure><figure class="relative max-w-sm cursor-pointer filter blur-sm hover:blur-none"><img class="w-128" src="Images/life2.jpg" alt="image description"><figcaption class="absolute px-4 text-lg text-white bottom-20"><p>We foster an environment where relationships matter within our teammates to build our efficiency, innovate faster, and to learn from each other.</p></figcaption></figure></div><div class="flex max-w-screen-sm pb-5 mx-auto"><figure class="relative max-w-sm cursor-pointer filter blur-sm hover:blur-none"><img class="w-128" src="Images/life3.jpg" alt="image description"><figcaption class="absolute px-4 text-lg text-white bottom-20"><p>We believe that being disciplined is critical to our success, not only for one&#39;s self but also for everyone in the team.</p></figcaption></figure><figure class="relative max-w-sm cursor-pointer filter blur-sm hover:blur-none"><img class="h-64 w-128" src="Images/life4.jpg" alt="image description"><figcaption class="absolute px-4 text-lg text-white bottom-1"><p>We carefully choose our decisions and consult one another to strengthen the culture of pursuing excellence here at CCK. We are determined to achieve our goals and ensure success in things being done.</p></figcaption></figure></div></div><div><hr class="my-6 border-yellow-300 sm:mx-auto dark:border-yellow-300 lg:my-8"><h1 class="grid text-3xl font-bold text-yellow-300 uppercase place-content-center">Job Opportunities</h1><hr class="my-6 border-yellow-300 sm:mx-auto dark:border-yellow-300 lg:my-8"><h1 class="grid text-5xl font-bold text-white uppercase place-content-center">DREAM BIG. SOAR HIGH. BE QUALIFIED.</h1><p class="grid mt-5 text-3xl text-justify place-content-center"> We may have something what you&#39;re looking for! </p><div class="flex max-w-screen-lg mx-auto items-justify"><div class="mt-10 ml-20 shadow-xl card w-96 bg-base-300"><div class="text-justify card-body"><h2 class="text-white card-title">DATA ENCODER</h2><p class="grid">Entering accurate data while following all regulations and maintaining confidentiality as agreed with the client.</p></div></div><div class="mt-10 ml-10 shadow-xl card w-96 bg-base-300"><div class="text-justify card-body"><h2 class="text-white card-title">ENGLISH TEST RATER</h2><p class="grid place-content-center">Evaluates student responses to subject-related and open-ended questions according to a customer supplied scoring guide. Successfully internalizes training and customer scoring guide. Scorers will work in an office environment.</p></div></div></div><div class="flex max-w-screen-lg mx-auto items-justify"><div class="mt-10 ml-20 shadow-xl card w-96 bg-base-300"><div class="text-justify card-body"><h2 class="text-white card-title">SOFTWARE DEVELOPER</h2><p class="grid place-content-center">Design and Develop web application using ASP.NET MVC. and WCF Web. Provide web development and support on product sites using the following environments: Ubuntu, Apache, mySQL and PHP (LAMP) and/or Windows+WAMPServer package, Subversion(SVN)/GIT, Zend Framework, jQuery, XDebug Services. Smartphone (Android and iPhone), Windows APP, Server (PHP, mySQL), Client (HTML, Java, CSS, AJAX)</p></div></div><div class="mt-10 ml-10 shadow-xl card w-96 bg-base-300"><div class="text-justify card-body"><h2 class="text-white card-title">CALL CENTER AGENT</h2><p class="grid">Be a person who handles incoming or outgoing customer calls for a business, handles account inquiries, customer complaints or support issues.</p></div></div></div></div><div class="flex flex-col items-center justify-center h-64 mt-10 bg-blue-800"><h1 class="text-5xl font-bold text-white">Be a part of our team!</h1><p class="max-w-screen-xl mx-auto mt-5 text-2xl text-justify text-white"> We will help you achieve your goals. We will help you build a career here in CCK. </p><div class="grid mt-5 place-content-end"><button class="inline-flex items-center justify-center px-10 py-3 text-3xl text-center text-white bg-orange-600 border border-orange-300 rounded-lg hover:text-orange-300 sm:ms-4 hover:bg-transparent focus:ring-4 focus:ring-orange-300"> Join Us! </button></div></div><hr class="border-yellow-300 sm:mx-auto dark:border-yellow-300"><!--]-->`);
    };
  }
};
...
const _sfc_main$6 = /* @__PURE__ */ Object.assign({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[--><section class="bg-center bg-no-repeat bg-[url(&#39;https://flowbite.s3.amazonaws.com/docs/jumbotron/conference.jpg&#39;)] bg-gray-700 bg-blend-multiply"><div class="max-w-screen-xl mx-auto lg:py-56"><p class="mb-4 text-4xl font-extrabold leading-none tracking-tight text-white uppercase md:text-5xl lg:text-6xl"> Our business is to guarantee the success of yours. </p><p class="mt-5 text-2xl text-white"> Every business is different; every business needs specific outsourcing services. And we can help you there. CCK City Network, Inc. has the keys to help you accelerate the growth of your business. </p></div></section><button type="button" id="btn-back-to-top" class="!fixed bottom-5 end-5 hidden rounded-full bg-orange-600 p-3 text-xs font-medium uppercase leading-tight text-white border border-orange-300 shadow-md transition duration-150 ease-in-out hover:bg-transparent hover:shadow-lg hover:text-orange-300 focus:bg-orange-600 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-orange-600 active:shadow-lg"><span class="[&amp;&gt;svg]:w-4"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="3" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 10.5 12 3m0 0 7.5 7.5M12 3v18"></path></svg></span></button><div><hr class="my-6 border-yellow-300 sm:mx-auto dark:border-yellow-300 lg:my-8"><h1 class="grid mx-auto text-4xl font-bold text-yellow-300 uppercase place-content-center">OUR BUSINESS</h1><hr class="my-6 border-yellow-300 sm:mx-auto dark:border-yellow-300 lg:my-8"><h1 class="grid mb-5 text-4xl font-bold text-white place-content-center">Made of Honesty and Experience</h1><p class="flex max-w-screen-xl mx-auto text-xl text-justify text-white"> Integrity is present in every level of interaction, simultaneously guaranteeing the security and protection of our clients’ valued assets. CCK also keeps its customers and businesses away from security risks, bringing confidence in service delivery. </p></div><hr class="my-6 border-yellow-300 sm:mx-auto dark:border-yellow-300 lg:my-8"><div class="flex items-center h-64 max-w-screen-lg mx-auto text-black bg-gray-600 carousel"><div id="slide1" class="relative flex items-center justify-center w-full carousel-item"><div><p class="pl-20 text-2xl">&quot;Invested and inspired, that&#39;s what we are.&quot;</p><p class="flex pl-20 pr-20 text-md">The staggering brain power of our teams is composed of skilled and experienced employees, consistently available to produce and perform. </p></div><div class="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2"><a href="#slide2" class="btn btn-circle">❮</a><a href="#slide2" class="btn btn-circle">❯</a></div></div><div id="slide2" class="relative flex items-center justify-center w-full carousel-item"><div><p class="text-2xl">&quot;How can we help you today?&quot;</p><p class="flex text-md">The services offered by CCK City Network, Inc. rest on the values of quality, accuracy, and data security. The company understands the complex structure of sustaining and growing a business that relies on the superior quality of services it needs, the accuracy of the output it requires, and the security of data and information it owns. </p></div><div class="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2"><a href="#slide1" class="btn btn-circle">❮</a><a href="#slide1" class="btn btn-circle">❯</a></div></div></div><hr class="my-6 border-yellow-300 sm:mx-auto dark:border-yellow-300 lg:my-8"><div><hr class="my-6 border-yellow-300 sm:mx-auto dark:border-yellow-300 lg:my-8"><h1 class="grid mx-auto text-4xl font-bold text-yellow-300 uppercase place-content-center">INDUSTRIES WE SERVE</h1><hr class="my-6 border-yellow-300 sm:mx-auto dark:border-yellow-300 lg:my-8"><p class="flex max-w-screen-xl mx-auto text-xl text-justify text-white"> With over 30 years of experience in handling cost-effective and secure business process outsourcing services, sales and marketing, and programming and software development, CCK City Network, Inc. has been successful in engaging and innovating for an extensive variety of industries such as education, technology, real-estate, advertising, manufacturing, energy, government, healthcare, retail, telecommunication, and trading. So, whether your growth objectives demand business processes, marketing, or technology, with our industry experience and aptitude for innovation, we can make the best solutions for your business, big or small. </p></div><div><hr class="my-6 border-yellow-300 sm:mx-auto dark:border-yellow-300 lg:my-8"><h1 class="grid mx-auto text-4xl font-bold text-yellow-300 uppercase place-content-center">BLOGS</h1><hr class="my-6 border-yellow-300 sm:mx-auto dark:border-yellow-300 lg:my-8"></div><div class="flex flex-col items-center justify-center h-64 pb-10 bg-blue-600"><h1 class="text-5xl font-bold text-white">Stop there, we have something for you.</h1><p class="max-w-screen-xl mx-auto mt-5 text-2xl text-justify text-white"> Join our family and discover that working does not have to be stressful and demanding. We treat each other in ways that foster healthy personal and professional spaces that we are always excited to have and experience. </p></div><hr class="border-yellow-300 sm:mx-auto dark:border-yellow-300"><!--]-->`);
    };
  }
});
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[--><section class="bg-center bg-no-repeat bg-[url(&#39;https://flowbite.s3.amazonaws.com/docs/jumbotron/conference.jpg&#39;)] bg-gray-700 bg-blend-multiply"><div class="max-w-screen-xl px-4 py-24 mx-auto text-center lg:py-56"><h1 class="mb-4 text-4xl font-extrabold leading-none tracking-tight text-white md:text-5xl lg:text-6xl"> It takes more than interest, we have plans and strategies specifically for your business needs. </h1></div></section><button type="button" id="btn-back-to-top" class="!fixed bottom-5 end-5 hidden rounded-full bg-orange-600 p-3 text-xs font-medium uppercase leading-tight text-white border border-orange-300 shadow-md transition duration-150 ease-in-out hover:bg-transparent hover:shadow-lg hover:text-orange-300 focus:bg-orange-600 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-orange-600 active:shadow-lg"><span class="[&amp;&gt;svg]:w-4"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="3" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 10.5 12 3m0 0 7.5 7.5M12 3v18"></path></svg></span></button><div class="mb-5"><h1 class="grid mt-10 mb-5 text-3xl font-bold text-white uppercase place-content-center">Software Development Quote - Software Development Services Pricing</h1><h1 class="flex items-center justify-center mb-5 text-xl text-white">Kindly fill the form below to get quote for your software development requirements. You will get the quote within 24 hours.</h1><div class="flex flex-row justify-center"><form class="flex flex-col justify-center"><label for="name">Full Name</label><input type="text"${ssrRenderAttr("value", unref(form).name)} class="mb-3 rounded-md w-96">`);
      if (unref(form).errors.name) {
        _push(`<div class="text-red-600">${ssrInterpolate(unref(form).errors.name)}</div>`);
      } else {
        _push(`<!---->`);
      ...
      _push(`<button class="justify-center py-2 mt-5 text-xl text-center text-white uppercase bg-orange-600 border border-orange-300 rounded-lg hover:text-orange-300 hover:bg-transparent focus:ring-4 focus:ring-orange-300"> Submit </button> *All Fields are Mandatory </form></div></div><!--]-->`);
    };
  }
};
