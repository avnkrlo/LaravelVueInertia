...
import { ref, unref, withCtx, createVNode, createTextVNode, useSSRContext, onMounted, onUnmounted, resolveComponent, mergeProps, createSSRApp, h as h$1 } from "vue";
...
const _sfc_main$8 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<button class="justify-center py-2 mt-5 text-xl text-center text-white uppercase bg-orange-600 border border-orange-300 rounded-lg hover:text-orange-300 hover:bg-transparent focus:ring-4 focus:ring-orange-600"> Submit </button> *All Fields are Mandatory </form></div></div><h1 class="grid mt-10 ml-20 text-3xl font-bold text-white uppercase">Data Entry Services Pricing - Frequently Asked Questions (FAQs)</h1><div class="grid pl-20 pr-20 mt-5 mb-5 place-content-center"><div class="border collapse collapse-plus"><input type="radio" name="my-accordion-3" checked="checked"><div class="text-xl font-semibold text-orange-400 collapse-title"> How much do you charge for data entry services? </div><div class="collapse-content"><p class="mb-2 text-white">For both online and offline data entry works, it costs $4 per hour and $700 per month (A Full Time Equivalent data entry operator).</p><p class="mb-2 text-white">Please fill in the ‘data entry quote’ form for both hourly and FTE requirements. For hourly rates, you will get the total number of hours and the total data entry services pricing for performing/executing your project.</p><p class="mb-2 text-white">For monthly rates, it will be easy for us to address you if we know about the nature of your data entry work.</p></div></div><div class="border collapse collapse-plus"><input type="radio" name="my-accordion-3"><div class="text-xl font-semibold text-orange-400 collapse-title"> Are there any upfront costs? </div><div class="collapse-content"><p class="mb-2 text-white">No upfront cost is charged for anyone who represents a company.</p><p class="mb-2 text-white">If you prefer to outsource as an individual rather than a company&#39;s representative, you have to pay 50 percent of the total cost as an upfront cost. That too will be charged only for the first time. We will not charge for further projects.</p><p class="mb-2 text-white">If you represent a company, you don’t have to pay a penny before outsourcing.</p></div></div><div class="border collapse collapse-plus"><input type="radio" name="my-accordion-3"><div class="text-xl font-semibold text-orange-400 collapse-title"> How do you calculate costs? </div><div class="collapse-content"><p class="mb-2 text-white">In the case of monthly works, the cost is fixed i.e., $700 per month.</p><p class="mb-2 text-white">For hourly works, the cost is just $4. We calculate costs based on the total number of hours required to complete your entire project.</p></div></div><div class="border collapse collapse-plus"><input type="radio" name="my-accordion-3"><div class="text-xl font-semibold text-orange-400 collapse-title"> Tell me about the payment cycle for Hourly Works. </div><div class="collapse-content"><p class="mb-2 text-white">For hourly works, you have to make payment on the same day we deliver the output file as we stipulated in the quote.</p><p class="mb-2 text-white">After completing the project we will send you the output along with the invoice. If you can’t pay on that time, prior information should be sent accordingly.</p></div></div><div class="border collapse collapse-plus"><input type="radio" name="my-accordion-3"><div class="text-xl font-semibold text-orange-400 collapse-title"> What about the payment cycle for monthly works? </div><div class="collapse-content"><p class="mb-2 text-white">In the case of monthly works, we prefer bi-weekly payment after the execution date. After making 2 bi-weekly payments, the payment has to be done monthly on the pre-determined date.</p><p class="mb-2 text-white">If you wish to have different payment cycle, you can (or) please feel free to hash over that.</p></div></div><div class="border collapse collapse-plus"><input type="radio" name="my-accordion-3"><div class="text-xl font-semibold text-orange-400 collapse-title"> How do you accept payment? </div><div class="collapse-content"><p class="mb-2 text-white">We mostly work with the international clients. So we accept payments through PayPal or Wire Transfer.</p></div></div><div class="border collapse collapse-plus"><input type="radio" name="my-accordion-3"><div class="text-xl font-semibold text-orange-400 collapse-title"> How abot the quality of work? </div><div class="collapse-content"><p class="mb-2 text-white">Premium quality in our work is our strength. We are keen in providing utmost quality in our output.</p><p class="mb-2 text-white">We will give a sample of our work through which you can come to an idea about our quality.</p></div></div><div class="border collapse collapse-plus"><input type="radio" name="my-accordion-3"><div class="text-xl font-semibold text-orange-400 collapse-title"> What about the data protection? </div><div class="collapse-content"><p class="mb-2 text-white">All major files are transmitted only through secured FTP server. We are solely responsible for the security of the data throughout the project period.</p><p class="mb-2 text-white">We are also ready to sign SLAs or any other documents that support data protection.</p></div></div><div class="border collapse collapse-plus"><input type="radio" name="my-accordion-3"><div class="text-xl font-semibold text-orange-400 collapse-title"> What about the turnaround time? </div><div class="collapse-content"><p class="mb-2 text-white">Turnaround time will be determined separately for hourly rate and monthly rate works.</p><p class="mb-2 text-white">For hourly rate works, we will work out a sample and impart you about the quantity of work done in an hour. From this sample work data, we will calculate the total number of hours required to complete the project. This will be apparently explained in our quote by stating the overall time assigned for the work.</p><p class="mb-2 text-white">In the case of monthly rate works, we will give you the performance of a day’s work i.e., 8 hours as a sample from which you can know about the turnaround time for the project.</p></div></div><div class="border collapse collapse-plus"><input type="radio" name="my-accordion-3"><div class="text-xl font-semibold text-orange-400 collapse-title"> How can we know about the status of the project and how our queries are handled? </div><div class="collapse-content"><p class="mb-2 text-white">The status of the project will be reported within few hours upon your query via Email.</p><p class="mb-2 text-white">We respond immediately if there are any major issues or updates. Our account manager will reply as early as possible to emails in case of urgent queries.</p><p class="mb-2 text-white">Please remember, you are always welcome to contact us anytime via phone if there is any significant change in your project.</p></div></div><div class="border collapse collapse-plus"><input type="radio" name="my-accordion-3"><div class="text-xl font-semibold text-orange-400 collapse-title"> Is there any agreement before outsourcing? </div><div class="collapse-content"><p class="mb-2 text-white">Yes. We make an agreement for monthly works. We prepare SLA before starting any outsourcing task on a monthly basis.</p><p class="mb-2 text-white">In the case of hourly work, instead of an agreement, we give you our quote along with all the terms and conditions associated with the project.</p></div></div><div class="border collapse collapse-plus"><input type="radio" name="my-accordion-3"><div class="text-xl font-semibold text-orange-400 collapse-title"> Can I hire you on a trial period basis? </div><div class="collapse-content"><p class="mb-2 text-white">Of course, yes, you can hire us based on the working period.</p><p class="mb-2 text-white">You can hire us for a day’s period for quality as well as performance measurement and review our quote price.</p></div></div><div class="border collapse collapse-plus"><input type="radio" name="my-accordion-3"><div class="text-xl font-semibold text-orange-400 collapse-title"> What is the eligibility of your data entry operators? </div><div class="collapse-content"><p class="mb-2 text-white">Our data entry operators are undergraduates and they are experts in touch typing.</p><p class="mb-2 text-white">We conduct various typing tests like 10 key tests, speed typing test, etc. and hire highly skilled data entry operators.</p></div></div><div class="border collapse collapse-plus"><input type="radio" name="my-accordion-3"><div class="text-xl font-semibold text-orange-400 collapse-title"> I have a specialized data entry more of a Virtual Assistant work. Could you perform that? </div><div class="collapse-content"><p class="mb-2 text-white">Yes. We can perform web search or any other requested VA works.</p><p class="mb-2 text-white">Please explain your description/requirements clearly so that we can meet your expectations.</p></div></div><div class="border collapse collapse-plus"><input type="radio" name="my-accordion-3"><div class="text-xl font-semibold text-orange-400 collapse-title"> Why is our phone number to be given mandatory? </div><div class="collapse-content"><p class="mb-2 text-white">We use your phone number only to contact you in case of emergencies regarding your project on not getting your reply via e-mail. Otherwise, we never disturb you and never share or forward your phone number to other companies or anybody. </p></div></div></div><!--]-->`);
    };
  }
};
...
const _sfc_main$6 = /* @__PURE__ */ Object.assign({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Parallaxy = resolveComponent("Parallaxy");
      _push(`<!--[--><section class="bg-center bg-no-repeat bg-[url(&#39;https://flowbite.s3.amazonaws.com/docs/jumbotron/conference.jpg&#39;)] bg-gray-700 bg-blend-multiply" data-v-941a1d56><div class="max-w-screen-xl mx-auto lg:py-56" data-v-941a1d56><p class="mb-4 text-4xl font-extrabold leading-none tracking-tight text-white uppercase md:text-5xl lg:text-6xl" data-v-941a1d56> Our business is to guarantee the success of yours. </p><p class="mt-5 text-2xl text-white" data-v-941a1d56> Every business is different; every business needs specific outsourcing services. And we can help you there. CCK City Network, Inc. has the keys to help you accelerate the growth of your business. </p></div></section><button type="button" id="btn-back-to-top" class="!fixed bottom-5 end-5 hidden rounded-full bg-orange-600 p-3 text-xs font-medium uppercase leading-tight text-white border border-orange-300 shadow-md transition duration-150 ease-in-out hover:bg-transparent hover:shadow-lg hover:text-orange-300 focus:bg-orange-600 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-orange-600 active:shadow-lg" data-v-941a1d56><span class="[&amp;&gt;svg]:w-4" data-v-941a1d56><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="3" stroke="currentColor" data-v-941a1d56><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 10.5 12 3m0 0 7.5 7.5M12 3v18" data-v-941a1d56></path></svg></span></button><div class="mb-10" data-v-941a1d56><hr class="my-6 border-yellow-300 sm:mx-auto dark:border-yellow-300 lg:my-8" data-v-941a1d56><h1 class="grid mx-auto text-4xl font-bold text-yellow-300 uppercase place-content-center" data-v-941a1d56>OUR BUSINESS</h1><hr class="my-6 border-yellow-300 sm:mx-auto dark:border-yellow-300 lg:my-8" data-v-941a1d56><h1 class="grid mb-5 text-4xl font-bold text-white place-content-center" data-v-941a1d56>Made of Honesty and Experience</h1><p class="flex max-w-screen-xl mx-auto text-xl text-justify text-white" data-v-941a1d56> Integrity is present in every level of interaction, simultaneously guaranteeing the security and protection of our clients’ valued assets. CCK also keeps its customers and businesses away from security risks, bringing confidence in service delivery. </p></div><div class="mt-10" data-v-941a1d56>`);
      _push(ssrRenderComponent(_component_Parallaxy, {
        speed: 0,
        class: "relative flex justify-center items-center"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img src="Images/life3.jpg" class="h-84 md:w-3/4" data-v-941a1d56${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
      ...
      _push(`<div class="mt-10" data-v-941a1d56><div class="slideshow" data-v-941a1d56><img${ssrRenderAttr("src", items[currentIndex.value].src)}${ssrRenderAttr("alt", items[currentIndex.value].alt)} class="slideshow-image" data-v-941a1d56></div></div></div><div data-v-941a1d56><hr class="my-6 border-yellow-300 sm:mx-auto dark:border-yellow-300 lg:my-8" data-v-941a1d56><h1 class="grid mx-auto text-4xl font-bold text-yellow-300 uppercase place-content-center" data-v-941a1d56>INDUSTRIES WE SERVE</h1><hr class="my-6 border-yellow-300 sm:mx-auto dark:border-yellow-300 lg:my-8" data-v-941a1d56><p class="flex max-w-screen-xl mx-auto text-xl text-justify text-white" data-v-941a1d56> With over 30 years of experience in handling cost-effective and secure business process outsourcing services, sales and marketing, and programming and software development, CCK City Network, Inc. has been successful in engaging and innovating for an extensive variety of industries such as education, technology, real-estate, advertising, manufacturing, energy, government, healthcare, retail, telecommunication, and trading. So, whether your growth objectives demand business processes, marketing, or technology, with our industry experience and aptitude for innovation, we can make the best solutions for your business, big or small. </p></div><div data-v-941a1d56><hr class="my-6 border-yellow-300 sm:mx-auto dark:border-yellow-300 lg:my-8" data-v-941a1d56><h1 class="grid mx-auto text-4xl font-bold text-yellow-300 uppercase place-content-center" data-v-941a1d56>BLOGS</h1><hr class="my-6 border-yellow-300 sm:mx-auto dark:border-yellow-300 lg:my-8" data-v-941a1d56></div><div class="flex flex-col items-center justify-center h-64 bg-blue-600" data-v-941a1d56><h1 class="text-5xl font-bold text-white mt-10" data-v-941a1d56>Stop there, we have something for you.</h1><p class="max-w-screen-xl mx-auto mt-3 text-2xl text-justify text-white" data-v-941a1d56> Join our family and discover that working does not have to be stressful and demanding. We treat each other in ways that foster healthy personal and professional spaces that we are always excited to have and experience. </p></div><hr class="border-yellow-300 sm:mx-auto dark:border-yellow-300" data-v-941a1d56><!--]-->`);
    };
  }
});
...
const Index = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-941a1d56"]]);
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[--><button type="button" id="btn-back-to-top" class="!fixed bottom-5 end-5 hidden rounded-full bg-orange-600 p-3 text-xs font-medium uppercase leading-tight text-white border border-orange-300 shadow-md transition duration-150 ease-in-out hover:bg-transparent hover:shadow-lg hover:text-orange-300 focus:bg-orange-600 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-orange-600 active:shadow-lg"><span class="[&amp;&gt;svg]:w-4"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="3" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 10.5 12 3m0 0 7.5 7.5M12 3v18"></path></svg></span></button><div class="mb-5 pt-10"><h1 class="grid mt-10 mb-5 text-3xl font-bold text-white uppercase place-content-center">Software Development Quote - Software Development Services Pricing</h1><h1 class="flex items-center justify-center mb-5 text-xl text-white">Kindly fill the form below to get quote for your software development requirements. You will get the quote within 24 hours.</h1><div class="flex flex-row justify-center"><form class="flex flex-col justify-center"><label for="name" class="block text-sm font-medium leading-6 text-white">Full Name</label><input${ssrRenderAttr("value", unref(form).name)} type="text" name="first-name" id="first-name" autocomplete="given-name" class="mb-3 block w-full rounded-md border-0 pl-2 py-1.5 text-white shadow-sm ring-1 ring-inset ring-orange-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-orange-600 text-xl sm:text-sm sm:leading-6 md:text-md md:leading-6 lg:text-lg lg:leading-6">`);
      if (unref(form).errors.name) {
        _push(`<div class="text-red-600">${ssrInterpolate(unref(form).errors.name)}</div>`);
      } else {
        _push(`<!---->`);
